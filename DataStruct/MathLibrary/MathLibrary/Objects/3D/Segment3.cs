...
namespace Dest
{
	namespace Math
	{
		...
		public struct Segment3
		{
			...
			public Segment3(ref Vector3D p0, ref Vector3D p1)
			{
				P0 = p0;
				P1 = p1;
				Center = Direction = Vector3D.zero;
				Extent = 0f;
			...
			/// <param name="p0">Segment start point</param>
			/// <param name="p1">Segment end point</param>
			public Segment3(Vector3D p0, Vector3D p1)
			{
				P0 = p0;
				P1 = p1;
				Center = Direction = Vector3D.zero;
			...
			public Segment3(ref Vector3D center, ref Vector3D direction, double extent)
			{
				Center = center;
				Direction = direction;
				Extent = extent;
			...
			/// <param name="direction">Direction of the segment. Must be unit length!</param>
			/// <param name="extent">Half-length of the segment</param>
			public Segment3(Vector3D center, Vector3D direction, double extent)
			{
				Center = center;
				Direction = direction;
				Extent = extent;
			...
			/// </summary>
			public void SetCenterDirectionExtent(Vector3D center, Vector3D direction, double extent)
			{
				Center = center;
				Direction = direction;
				Extent = extent;
