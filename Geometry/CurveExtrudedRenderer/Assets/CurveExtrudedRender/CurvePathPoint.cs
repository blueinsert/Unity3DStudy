...
namespace bluebean
{
    ...
    public class CurvePathPoint
    {
        ...
        public CurvePathPoint() { }

        public CurvePathPoint(Vector3 position, Vector3 tangent, Vector3 normal, Vector3 binormal, Vector4 color, float thickness)
        {
        ...
        public static CurvePathPoint operator +(CurvePathPoint c1, CurvePathPoint c2)
        {
            return new CurvePathPoint(c1.position + c2.position, c1.tangent + c2.tangent, c1.normal + c2.normal, c1.binormal + c2.binormal, c1.color + c2.color, c1.thickness + c2.thickness);
        }

        public static CurvePathPoint operator *(float f, CurvePathPoint c)
        {
            return new CurvePathPoint(c.position * f, c.tangent * f, c.normal * f, c.binormal * f, c.color * f, c.thickness * f);
        }

        public static void WeightedSum(float w1, float w2, float w3, ref CurvePathPoint c1, ref CurvePathPoint c2, ref CurvePathPoint c3, ref CurvePathPoint sum)
        {
        ...
        public void Transport(CurvePathPoint frame, float twist)
        {
