...
namespace bluebean
{
    ...
    {
        static int particleBrushHash = "BrushHash".GetHashCode();

        public IBrushMode brushMode;
        ...
        public BrushBase(Action onStrokeStart, Action onStrokeUpdate, Action onStrokeEnd)
        {
