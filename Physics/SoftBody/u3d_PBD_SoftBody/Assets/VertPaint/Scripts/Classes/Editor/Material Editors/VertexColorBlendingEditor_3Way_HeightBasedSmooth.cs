...
internal class VertexColorBlendingEditor_3Way_HeightBasedSmooth : VertexColorBlendingEditorBase
{
    ...
    private MaterialProperty heightShift1, heightShift2, heightShift3, transitionSmoothness;
    ...
    public override void OnEnable()
    {
        ...
        transitionSmoothness = GetMaterialProperty(targetObjects, 21);
    }
