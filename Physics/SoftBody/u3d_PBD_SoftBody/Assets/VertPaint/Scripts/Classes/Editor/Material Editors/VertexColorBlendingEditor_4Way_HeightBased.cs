...
internal class VertexColorBlendingEditor_4Way_HeightBased : VertexColorBlendingEditorBase
{
    ...
    private MaterialProperty blend1, blend2, blend3;
    ...
    public override void OnEnable()
    {
        ...
        color4 = GetMaterialProperty(targetObjects, 18);
        albedo4 = GetMaterialProperty(targetObjects, 19);
        normalmap4 = GetMaterialProperty(targetObjects, 20);
        mshao4 = GetMaterialProperty(targetObjects, 21);
        smoothness4 = GetMaterialProperty(targetObjects, 22);
        normalmapStrength4 = GetMaterialProperty(targetObjects, 23);

        blend1 = GetMaterialProperty(targetObjects, 24);
        blend2 = GetMaterialProperty(targetObjects, 25);
        blend3 = GetMaterialProperty(targetObjects, 26);
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        blend3.floatValue = EditorGUILayout.Slider("Blue Blend", blend3.floatValue, -3, 1);
