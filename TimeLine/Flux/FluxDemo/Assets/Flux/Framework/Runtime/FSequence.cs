...
namespace Flux
{
	...
	public class FSequence : FObject
	{
        ...
        private int m_RelesingId;

        public int RelesingID { get { return m_RelesingId; } }
...
//		}
        ...
        private SequenceStopEvent _onStopedCallback = new SequenceStopEvent();

        public SequenceStopEvent OnStopedCallBack { get { return _onStopedCallback; } }
		...
		{
            //Fish:Mathf.Clamp（a,b,c） 使a限制在b，c之間
            CurrentTime = Mathf.Clamp( time, 0, LengthTime );
		...
		public float CurrentTime {
			...
			private set {
				...
				else
				{
                    ...
                    /*Fish: Mathf.FloorToInt(f)返回小於等於f的最大整數 比如 Mathf.FloorToInt（1.99）= 1
                     Mathf.CeilToInt（f） 返回大於等於f的最小整數比如Mathf.CeilToInt(1.1) = 2        */
		...
		public void Stop( bool reset )
		{
			...
			CurrentTime = -1;
			_lastUpdateTime = 0;
			if (_onStopedCallback != null) _onStopedCallback.Invoke(this);
        }
...
//			UpdateTimelineIds();
        ...
        public void UpdateOwner()
        {
            ...
            {
                foreach (var t in container.Timelines)
                {
                    t.UpdateOwner();
                }
            }
        ...
        public void SetRelesingID(int id)
        {
            m_RelesingId = id;
        }
    ...
    public class SequenceStopEvent : UnityEvent<FSequence>
    {
