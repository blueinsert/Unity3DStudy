...
namespace bluebean
{
    ...
    {
        public const string TexturesFolder = "TreeEditorTextures";
        ...
        public static void LoadTexture(string name, TexType type = TexType.PNG)
        {
            ...
            string path = GetTextureFolderPath()+"/"+filename;
        ...
        {
            string fullpath = getFullPath(Application.dataPath, TexturesFolder);
            ...
            Debug.LogError("Could not find folder: " + TexturesFolder);
            return "";
        }
