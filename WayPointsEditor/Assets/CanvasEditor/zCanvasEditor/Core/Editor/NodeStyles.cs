...
public static  class NodeStyles {
		#region 自定义的 GUIStyle

		static GUIStyle _transitionLineOn;
		static GUIStyle _transitionLineOff;
		public static GUIStyle transitionLineOn{
			get{ 
				if (_transitionLineOn == null) {
					_transitionLineOn = new GUIStyle ();
					GUIStyleState tState = new GUIStyleState ();
					tState.background = AssetDatabase.LoadAssetAtPath<Texture2D> ("Assets/zCanvasEditor/Image/transitionLineOn.png");
					_transitionLineOn.normal = tState;
				}
				return _transitionLineOn;
			}
		}
		public static GUIStyle transitionLineOff{
			get{ 
				if (_transitionLineOff == null) {
					_transitionLineOff = new GUIStyle ();
					GUIStyleState tState = new GUIStyleState ();
					tState.background = AssetDatabase.LoadAssetAtPath<Texture2D> ("Assets/zCanvasEditor/Image/transitionLineOff.png");
					_transitionLineOff.normal = tState;
				}
				return _transitionLineOff;
			}
		}
		...
		public static GUIStyle WarningOverlay;
		...
		static NodeStyles(){
			...
			NodeStyles.WarningOverlay = "WarningOverlay";
